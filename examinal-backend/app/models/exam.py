...
class Exam(Base):
    ...
    enrollment_requests = relationship("EnrollmentRequest", back_populates="exam", cascade="all, delete-orphan")
    messages = relationship("InAppMessage", back_populates="exam", cascade="all, delete-orphan")
