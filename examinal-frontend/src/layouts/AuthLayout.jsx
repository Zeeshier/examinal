...
export default function AuthLayout() {
  return (
    <div className="min-h-screen bg-white flex font-sans selection:bg-blue-500/30 relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between p-16 relative overflow-hidden border-r border-slate-800">
        ...
        <div className="absolute top-[-20%] right-[-20%] w-[80%] h-[80%] bg-blue-500/20 rounded-full blur-[120px] animate-pulse pointer-events-none" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[60%] h-[60%] bg-cyan-500/10 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="relative z-10 mb-12">
          ...
          <h2 className="text-5xl font-black text-white leading-[1.1] tracking-tight mb-8">
            Access the <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-cyan-300 to-white italic">
              AI Assessment Node.
            </span>
          </h2>
      ...
      <div className="w-full lg:w-[55%] flex items-center justify-center p-8 md:p-16 relative overflow-hidden bg-slate-50">
